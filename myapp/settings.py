...
# Note that this is overriden later on Platform.sh
SECRET_KEY = 'w__xu0u9++p^@h!v19xse)u@)fy9%c2q_h8jf72el4910o1#+&'
...
# if we're running on platform, get database settings, else define ourselves
db_settings = {
